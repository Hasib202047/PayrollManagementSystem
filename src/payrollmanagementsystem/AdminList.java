...
public class AdminList extends javax.swing.JFrame {
    ...
    {
        try{
            String sql="SELECT EMPLOYEE.Emp_ID,Admin_Id,Emp_Dept,Emp_Name,Emp_DOB,Emp_Age,Emp_Gender,Emp_Religion,Emp_Doj,Emp_Address,Emp_City,Emp_Nationality,Emp_Email,Emp_PhoneNo FROM EMPLOYEE,ADMIN WHERE EMPLOYEE.Emp_ID=ADMIN.Emp_Id";
